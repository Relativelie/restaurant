export default {
  breakfast: [
    {
      ...
      price: 1,
      fillings: [
        { id: 1, name: 'with trout', price: 5, image: 'salmon.jpg' },
        { id: 2, name: 'with bacon', price: 3, image: 'bacon.jpg' },
        { id: 3, name: 'with jam', price: 2, image: 'jamTwo.jpg' },
...

    {
      ...
      price: 1,
      fillings: [
        { id: 9, name: 'with trout', price: 5, image: 'salmon.jpg' },
        { id: 10, name: 'with bacon', price: 3, image: 'bacon.jpg' },
        { id: 11, name: 'with jam', price: 2, image: 'jamTwo.jpg' },
...

    {
      ...
      price: 1,
      fillings: [
        { id: 13, name: 'with pineapple', price: 5, image: 'pineapple.jpg' },
        { id: 14, name: 'with peach', price: 3, image: 'peach.jpg' },
        { id: 15, name: 'with berries', price: 2, image: 'berries.jpg' },
  ...
  lunch: [
    ...
    },
    {
      ...
      price: 2,
      fillings: [
        { id: 13, name: 'with bacon', price: 5, image: 'bacon.jpg' },
        { id: 14, name: 'with beef', price: 6, image: 'beef.jpg' },
        { id: 15, name: 'Cheese', price: 3, image: 'cheese.jpg' },
        { id: 16, name: 'with chicken', price: 2, image: 'chicken.jpg' },
      ],
  ...
  dinner: [
    {
      ...
      price: 2,
      fillings: [
        { id: 17, name: 'with bacon', price: 5, image: 'bacon.jpg' },
        { id: 18, name: 'with beef', price: 6, image: 'beef.jpg' },
        { id: 19, name: 'with cheese', price: 3, image: 'cheese.jpg' },
        { id: 20, name: 'with chicken', price: 2, image: 'chicken.jpg' },
      ],
      image: 'pasta.jpg',
    },
    {
